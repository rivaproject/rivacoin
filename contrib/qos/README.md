...
This means one can have an always-on rivad instance running, and another local rivad/riva-qt instance which connects to this node and receives blocks from it.
