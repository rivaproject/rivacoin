...
RESOURCES += src/qt/riva.qrc src/qt/riva_locale.qrc

TRANSLATIONS += src/qt/locale/riva_bg.ts \
                src/qt/locale/riva_de.ts \
                src/qt/locale/riva_en.ts \
                src/qt/locale/riva_es.ts \
                src/qt/locale/riva_fi.ts \
                src/qt/locale/riva_fr.ts \
                src/qt/locale/riva_it.ts \
                src/qt/locale/riva_ja.ts \
                src/qt/locale/riva_pl.ts \
                src/qt/locale/riva_pt.ts \
                src/qt/locale/riva_ru.ts \
                src/qt/locale/riva_sk.ts \
                src/qt/locale/riva_sv.ts \
                src/qt/locale/riva_vi.ts \
                src/qt/locale/riva_zh_CN.ts \
                src/qt/locale/riva_zh_TW.ts
