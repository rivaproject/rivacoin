Contributing to Riva Core
============================

The Riva Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Riva Core project, and is not to be
confused with overall Riva Network Protocol consensus changes.

Whether a pull request is merged into Riva Core rests with the project merge
...
Patches that change Riva consensus rules are considerably more involved than
...
Where a patch set proposes to change the Riva consensus, it must have been
...
The project leader is the release manager for each Riva Core release.
