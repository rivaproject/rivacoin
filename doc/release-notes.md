Riva Core version 2.2.1 is now available from:

  <https://github.com/riva-project/riva/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/riva-project/riva/issues>

Compatibility
==============

Riva Core is extensively tested on multiple operating systems using
...
Riva Core should also work on most other Unix-like systems but is not
...
of Bitcoin that Riva was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/riva-project-translations/).
