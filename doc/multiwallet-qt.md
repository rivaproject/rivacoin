...
In order to support loading of multiple wallets in riva-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is riva.cpp.
...
Changes to riva.cpp
----------------------
riva.cpp is the entry point into riva-qt, and as such, will require some minor modifications to provide hooks for
