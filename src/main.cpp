...
#if defined(NDEBUG)
#error "Riva cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    } else if (nHeight <= 359 && nHeight > 0) {
        nSubsidy = 5 * COIN;
    } else if (nHeight <= 7200 && nHeight >360) {
        nSubsidy = 50 * COIN;
    } else if (nHeight <= 14400 && nHeight > 7201) {
        nSubsidy = 100 * COIN;
    } else if (nHeight <= 72000 && nHeight > 14401) {
        nSubsidy = 80 * COIN;
    } else if (nHeight <= 144000 && nHeight > 72001) {
        nSubsidy = 60 * COIN;
    } else if (nHeight <= 720000 && nHeight > 144001) {
        nSubsidy = 40 * COIN;
    } else if (nHeight <= 1440000 && nHeight > 720001) {
        nSubsidy = 20 * COIN;
	} else if (nHeight > 1440001) {
		nSubsidy = 10 * COIN;
    } else {
        nSubsidy = 0 * COIN;
    }
