...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Riva features */
        {"riva", "masternode", &masternode, true, true, false},
        {"riva", "masternodelist", &masternodelist, true, true, false},
        {"riva", "mnbudget", &mnbudget, true, true, false},
        {"riva", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"riva", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"riva", "mnsync", &mnsync, true, true, false},
        {"riva", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"riva", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use rivad, or the -server option to riva-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> riva-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:7075/\n";
}
