                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Riva Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Riva address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and riva: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Riva Core"), this);
    aboutAction->setStatusTip(tr("Show information about Riva Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Riva"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Riva addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Riva addresses"));
    ...
    openAction->setStatusTip(tr("Open a Riva: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Riva Core help message to get a list with possible Riva command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Riva Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Riva network", "", count));
}
...
{
    QString strTitle = tr("Riva Core"); // default title
